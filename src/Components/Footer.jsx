...
const Footer = () => {
    const handleSubs = () => {
        swal("Thanks!", "Stay with us", "success");
    }
  return (
    <div>
        ...
        <div className="max-w-[85rem] py-10 px-4 sm:px-6 lg:px-8 lg:pt-20 mx-auto">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-6">
            <div className="col-span-full lg:col-span-1">
              <a
                className="flex-none text-4xl  font-semibold text-yellow-600"
                href="#"
                aria-label="Brand"
              >
                Social Event
            ...
            {/* End Col */}
            <div className="col-span-1">
              <h4 className="font-semibold text-gray-100 text-2xl">Terms and Policies</h4>
              <div className="mt-3 grid space-y-3 text-xl">
                <p>
                  <a
                    className="inline-flex gap-x-2 text-gray-400 hover:text-gray-200"
            ...
            <div className="col-span-2">
              <h4 className="font-semibold text-gray-100 text-2xl">
                Stay up to date
              </h4>
              <form>
